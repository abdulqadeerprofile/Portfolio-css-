...
const Hero = () => {
  return (
    <div id='home' className="w-full pt-[4vh] md:pt-[12vh] h-screen bg-[#0d111a] overflow-hidden relative">
      <div className="flex justify-center flex-col w-4/5 h-full mx-auto ">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 ">
          ...
          {/* IMAGE CONTENT */}
          <div data-aos="zoom-in" data-aos-delay="400" className="mx-auto hidden lg:block rounded-[3rem] border-[3.5px] border-blue-900 overflow-hidden">

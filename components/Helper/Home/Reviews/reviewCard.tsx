...
const ReviewCard = ({review}:Props) => {
  ...
  return <div className='rounded-md overflow-hidden bg-[#070d14] m-4'>
    <div className='p-6'>
    ...
    <div className='px-6 py-3 mb-3 w-fit mx-auto rounded-full flex items-center space-x-3 bg-blue-800
